...
sprint_id: SP_022
tier: Foundational
features: [repo-read-extensions, engine-retrieval-surfaces, mcp-fetch-listentities, exposure-protocol-extend]
user_stories:
...
## Stage 3 — Plan Review (Foundational ⇒ ≥2 independent iterations)
...
## Stage 5 — Post-Implementation Review (plan-blind)
